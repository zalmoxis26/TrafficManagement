    ...
    <div class="container mt-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('traficos.update', $trafico->id) }}" method="POST" enctype="multipart/form-data"> <!-- Ruta para el envío del formulario -->
                    ...
                    <div class="row mb-2">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="aduana" name="aduana" list="aduanaOptions" value="{{ $trafico->aduana }}" placeholder="Ingrese el número de Aduana" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="patente" name="patente" value="{{ $trafico->patente }}" placeholder="Ingrese patente" required>
                            </div>
                        </div> 
                          <!-- Fecha -->
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" class="form-control" id="fecha" name="fechaReg" value="{{ $trafico->fechaReg }}" required>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="facturaNumero" name="factura" value="{{ $trafico->factura }}" placeholder="Ingrese el número de factura" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group mb-2 mb20">
                                ...
                                <select name="Toperacion" id="Toperacion" class="form-control" required>
                                    <option value="Importacion" {{ $trafico->Toperacion == 'Importacion' ? 'selected' : '' }}>
                                        {{ __('Importación') }}
                                    </option>
                                    <option value="Exportacion" {{ $trafico->Toperacion == 'Exportacion' ? 'selected' : '' }}>
                                        {{ __('Exportación') }}
                                    </option>
                                </select>
                            </div>  
                            ...
                            <div class="mb-3">
                                ...
                                <select id="empresa" class="form-control" name="empresa_id" required>
                                    ...
                                    @foreach ($empresas as $empresa)
                                        <option value="{{ $empresa->empresa->id }}" {{ $empresa->empresa->id == $trafico->empresa_id ? 'selected' : '' }}>{{ $empresa->empresa->descripcion }}</option>
                                    @endforeach
                                </select>
                            </div>       
                        </div>
                      ...
                      <div class="mb-3 mt-5 d-flex justify-content-center gap-2 fw-bold">
                        <div class="bg-light p-2 pt-3 border" style="width:25%;">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="lleva_revision" id="llevaRevisionSi" value="si" {{ $llevaRevision == 'si' ? 'checked' : '' }} required>
                                <label class="form-check-label" for="llevaRevisionSi">SI</label>
                            </div>

                            <!-- Opción "No" -->
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="lleva_revision" id="llevaRevisionNo" value="no" {{ $llevaRevision == 'no' ? 'checked' : '' }} required>
                                <label class="form-check-label" for="llevaRevisionNo">NO</label>
                            </div>
                            
                            <div class="text-center" id="ubicacionRevisionContainer" style="display: {{ $llevaRevision == 'si' ? 'block' : 'none' }}">
                                <hr>
                                <label for="ubicacionRevision" class="form-label">Ubicacion de Revision</label>
                                <input type="text" class="form-control" name="ubicacionRevision" id="ubicacionRevision" value="{{ $ubicacionRevision }}" placeholder="Ubicacion de Revision">
                            </div>
                        </div>
                    </div> 
