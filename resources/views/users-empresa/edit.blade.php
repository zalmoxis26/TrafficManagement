            ...
            <div class="col-md-8 mx-auto">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">{{ __('Actualizar') }} Empresas Asignadas</span>
                    ...
                    <div class="card-body bg-white">
                        <form method="POST" action="{{ route('users-empresas.update', $usersEmpresa->id) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf
